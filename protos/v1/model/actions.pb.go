...
type ActionRequest struct {
	...
	SeqId        string                 `protobuf:"bytes,8,opt,name=seq_id,json=seqId,proto3" json:"seq_id,omitempty"`
}
...
func (x *ActionRequest) GetSeqId() string {
	if x != nil {
		return x.SeqId
	}
	return ""
...
type ActionResponse struct {
	...
	SeqId      string                  `protobuf:"bytes,9,opt,name=seq_id,json=seqId,proto3" json:"seq_id,omitempty"`
}
...
func (x *ActionResponse) GetSeqId() string {
	if x != nil {
		return x.SeqId
	}
	return ""
...
var file_protos_model_v1_actions_proto_rawDesc = []byte{
	...
	0x5f, 0x69, 0x64, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x73, 0x65, 0x71, 0x49, 0x64,
	...
	0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x73, 0x65, 0x71, 0x49, 0x64, 0x42, 0x08, 0x0a,
