...
func (x *ActionRequest) GetRetryCount() string {
	if x != nil {
		return x.RetryCount
	}
	return ""
...
func (x *ActionResponse) GetRetryCount() string {
	if x != nil {
		return x.RetryCount
	}
	return ""
...
var file_protos_model_v1_actions_proto_rawDesc = []byte{
	...
	0x79, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x72,
	...
	0x6f, 0x75, 0x6e, 0x74, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x72, 0x65, 0x74, 0x72,
