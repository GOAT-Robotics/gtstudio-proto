...
const (
	...
	AgentRosBridge_GetActionRequestStream_FullMethodName       = "/v1.agent.AgentRosBridge/GetActionRequestStream"
	AgentRosBridge_SendActionResponse_FullMethodName           = "/v1.agent.AgentRosBridge/SendActionResponse"
)
...
func (c *agentRosBridgeClient) ReceiveRosMessages(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[ReceiveRosMessagesResponse, ReceiveRosMessagesRequest], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type AgentRosBridge_ReceiveRosMessagesClient = grpc.BidiStreamingClient[ReceiveRosMessagesResponse, ReceiveRosMessagesRequest]

func (c *agentRosBridgeClient) GetActionRequestStream(ctx context.Context, in *GetActionRequestStreamRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetActionRequestStreamResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &AgentRosBridge_ServiceDesc.Streams[5], AgentRosBridge_GetActionRequestStream_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type AgentRosBridge_GetActionRequestStreamClient = grpc.ServerStreamingClient[GetActionRequestStreamResponse]

func (c *agentRosBridgeClient) SendActionResponse(ctx context.Context, in *SendActionResponseRequest, opts ...grpc.CallOption) (*SendActionResponseResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SendActionResponseResponse)
	err := c.cc.Invoke(ctx, AgentRosBridge_SendActionResponse_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAgentRosBridgeServer) ReceiveRosMessages(grpc.BidiStreamingServer[ReceiveRosMessagesResponse, ReceiveRosMessagesRequest]) error {
	return status.Errorf(codes.Unimplemented, "method ReceiveRosMessages not implemented")
}
func (UnimplementedAgentRosBridgeServer) GetActionRequestStream(*GetActionRequestStreamRequest, grpc.ServerStreamingServer[GetActionRequestStreamResponse]) error {
	return status.Errorf(codes.Unimplemented, "method GetActionRequestStream not implemented")
}
func (UnimplementedAgentRosBridgeServer) SendActionResponse(context.Context, *SendActionResponseRequest) (*SendActionResponseResponse, error) {
...
func _AgentRosBridge_ReceiveRosMessages_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(AgentRosBridgeServer).ReceiveRosMessages(&grpc.GenericServerStream[ReceiveRosMessagesResponse, ReceiveRosMessagesRequest]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type AgentRosBridge_ReceiveRosMessagesServer = grpc.BidiStreamingServer[ReceiveRosMessagesResponse, ReceiveRosMessagesRequest]

func _AgentRosBridge_GetActionRequestStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(GetActionRequestStreamRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(AgentRosBridgeServer).GetActionRequestStream(m, &grpc.GenericServerStream[GetActionRequestStreamRequest, GetActionRequestStreamResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type AgentRosBridge_GetActionRequestStreamServer = grpc.ServerStreamingServer[GetActionRequestStreamResponse]

func _AgentRosBridge_SendActionResponse_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SendActionResponseRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AgentRosBridgeServer).SendActionResponse(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AgentRosBridge_SendActionResponse_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AgentRosBridgeServer).SendActionResponse(ctx, req.(*SendActionResponseRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AgentRosBridge_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AgentRosBridge_SendActionResponse_Handler,
		},
	},
	Streams: []grpc.StreamDesc{
		...
		},
		{
			...
			Handler:       _AgentRosBridge_GetActionRequestStream_Handler,
			ServerStreams: true,
		},
	},
