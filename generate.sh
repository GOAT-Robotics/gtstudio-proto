...
python3 -m grpc_tools.protoc -I. --python_out=/home/ros2/robotix-agent/node --grpc_python_out=/home/ros2/robotix-agent/node ./protos/agent/v1/agent.proto
...
do
    ...
    python3 -m grpc_tools.protoc -I. --python_out=/home/ros2/robotix-agent/node --grpc_python_out=/home/ros2/robotix-agent/node $f
